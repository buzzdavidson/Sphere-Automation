...
class SerialCommandPlugin(SerialBasePlugin):
    '''Starting point for serial plugins which perform bi-directional communication.
     Extends SerialBasePlugin to add command/response functionality.'''
