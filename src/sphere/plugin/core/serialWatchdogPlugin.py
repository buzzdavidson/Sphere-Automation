...
class SerialWatchdogPlugin(SerialListenerPlugin):
    '''Starting point for serial plugins which listen for messages from an underlying serial device and send notifications
    when a message has not been received within a specified time period.  Component also sends notification when messaging
    resumes.'''
