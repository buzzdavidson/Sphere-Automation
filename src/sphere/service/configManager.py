...
class ConfigManager(Controllable):
    def __init__(self):
        Controllable.__init__(self, 'Configuration Manager')

    def readComponentConfiguration(self, componentName):
        '''Read component configuration as dictionary of values'''
        return dict()
        
    def saveComponentConfiguration(self, componentName, configuration):
        '''Persist component configuration'''
        return None

    # TODO implementation of persistence mechanism should be pluggable and configured via plumberjack
